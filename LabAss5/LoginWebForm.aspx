...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SimpleDatabseConnectionString1 %>" DeleteCommand="DELETE FROM [Logon] WHERE [Username] = @Username" InsertCommand="INSERT INTO [Logon] ([Username], [password]) VALUES (@Username, @password)" ProviderName="<%$ ConnectionStrings:SimpleDatabseConnectionString1.ProviderName %>" SelectCommand="SELECT [Username], [password] FROM [Logon]" UpdateCommand="UPDATE [Logon] SET [password] = @password WHERE [Username] = @Username">
            <DeleteParameters>
